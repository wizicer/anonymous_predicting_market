...
describe("Testing ElGamal Scheme on EC points directly", () => {
    it("Check compliance of orignal and decrypted message as points", () => {
        ...
        console.log("original message:", encryption.message.toAffine().x.toString(), encryption.message.toAffine().y.toString());
        console.log("ephemeral_key:", encryption.ephemeral_key.toAffine().x.toString(), encryption.ephemeral_key.toAffine().y.toString());
        console.log("encrypted_message:", encryption.encrypted_message.toAffine().x.toString(), encryption.encrypted_message.toAffine().y.toString());
        console.log("nonce:", encryption.nonce.toString());
        console.log("privKey:", keypair.privKey.toString());
        console.log("pubKey:", keypair.pubKey.toAffine().x.toString(), keypair.pubKey.toAffine().y.toString());
        const decrypted_message = decrypt(
            keypair.privKey,
            encryption.ephemeral_key,
            encryption.encrypted_message,
        );
        console.log("decrypted_message:", decrypted_message.toAffine().x.toString(), decrypted_message.toAffine().y.toString());
